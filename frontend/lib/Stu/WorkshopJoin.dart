  ...
  Future<void> fetchWorkshops() async {
    try {
      ...
      setState(() {
        ...
        workshops = [
          WorkShopStruct(wsid: 1, wsdate: "2024-01-15", wstime: "10:00 AM", wstopic: "AI Basics"),
          WorkShopStruct(wsid: 2, wsdate: "2024-01-20", wstime: "2:00 PM", wstopic: "Flutter Development"),
        ];
      });
      // setState(() {});
    } catch (e) {
