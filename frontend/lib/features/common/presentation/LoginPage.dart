...
import '../../admin/presentation/AdminMainPage.dart';
import 'package:db_finalproject/features/common/logic/LoginService.dart';
          ...
          Row(
            ...
            children: [
              ...
              ElevatedButton(
                ...
                onPressed: (){
                  Navigator.push(context, MaterialPageRoute(builder: (context) => LoginForm(usertype: "judge")));
                }, 
                child: Text("評審委員")
              ),
              SizedBox(width: 20),
...
class _LoginFormState extends State<LoginForm> {
  ...
  Future<void> _login() async {
    ...
    String? response = await _loginService.login(widget.usertype, username, password);
